...
public class LocalAuthenticatorAdapterTest {
    ...
    private ApplicationConfig mockedApplicationConfig;
    ...
    public void buildEventContext() {
        ...
        mockedApplicationConfig = mock(ApplicationConfig.class);
        when(mockedApplicationConfig.isSaaSApp()).thenReturn(false);
    }
}
