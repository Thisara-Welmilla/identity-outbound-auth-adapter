...
import org.wso2.carbon.identity.application.authenticator.adapter.util.TestConstants.AuthenticatingUserConstants;
...
public class TestActionInvocationResponseBuilder {
    ...
    public static class ExternallyAuthenticatedUser extends AuthenticatedUserData.User {
        ...
        AuthenticatedUserData.Claim  userNameClaim = new AuthenticatedUserData.Claim (USERNAME_CLAIM,
                AuthenticatingUserConstants.USERNAME);
